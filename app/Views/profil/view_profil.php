            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="profile-work">
                        ...
                        <a class="btn rounded-pill btn-warning" style="color: white; text-decoration: none;" href="<?= base_url('profil/edit/' . session('nama')); ?>">EDIT PROFIL</a>
                        <?php if (session('nama') == 'Administrator') : ?>
                            <a class="btn rounded-pill btn btn-primary" href="<?= base_url(); ?>/admin">ADMIN PANEL</a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="col-md-6">
